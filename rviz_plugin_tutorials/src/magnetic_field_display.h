#ifndef MAGNETIC_FIELD_DISPLAY_H
#define MAGNETIC_FIELD_DISPLAY_H
...
class MagneticFieldDisplay: public rviz::MessageFilterDisplay<sensor_msgs::MagneticField>
{
Q_OBJECT
public:
  // Constructor.  pluginlib::ClassLoader creates instances by calling
  // the default constructor, so make sure you have one.
  MagneticFieldDisplay();
  virtual ~MagneticFieldDisplay();
...
private:
  ...
  boost::circular_buffer<boost::shared_ptr<MagneticFieldVisual> > visuals_;
